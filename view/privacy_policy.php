...
<nav class="navbar">
    <div class="logo"><a href="../landingpage.html">QUIZ BUZZ</a></div>
...
<div class="container">
    ...
    <p>At Quiz Buzz, your privacy is our priority. This Privacy Policy explains what data we collect, how we use it, and your rights.</p>
    ...
    <h2>Your Rights</h2>
    <p>You may request access, correction, or deletion of your personal data. For any requests, contact us through our contact page.</p>

    <h2>Cookies</h2>
    <p>We use cookies to improve site functionality and analytics. You can control cookie preferences through your browser settings.</p>
